...
secret_new_targets_1 = "new_mysecret4"
secret_new_targets_2 = "new_mysecret5"
...
generate_and_write_rsa_keypair("keys/new_targets_key1",   bits=2048, password=secret_new_targets_1)
generate_and_write_rsa_keypair("keys/new_targets_key2",   bits=2048, password=secret_new_targets_2)
